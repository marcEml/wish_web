 ...
 */
final class Version20250319142845 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE item (id SERIAL NOT NULL, name VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, external_link VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE membership (id SERIAL NOT NULL, user_id INT DEFAULT NULL, status VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_86FFD285A76ED395 ON membership (user_id)');
        $this->addSql('CREATE TABLE purchase (id SERIAL NOT NULL, user_id INT DEFAULT NULL, item_id INT DEFAULT NULL, message VARCHAR(255) NOT NULL, receipt_url VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "user" (id SERIAL NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, password_salt INT DEFAULT NULL, status VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
